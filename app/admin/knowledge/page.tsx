        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "12px" }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
              <span style={{ fontFamily: "'Noto Kufi Arabic', serif", fontSize: "16px", fontWeight: 700, color: "#1A2744" }}>
                {src.title}
              </span>
            ...
            <p style={{ fontSize: "11px", color: "#C4C4C0", marginTop: "8px" }}>
              {src.content.length} حرف
            </p>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "6px", flexShrink: 0 }}>
            <button
              onClick={startEdit}
              style={{ background: "#F0F4FF", border: "none", borderRadius: "8px", padding: "7px 12px", cursor: "pointer", color: "#2563EB", fontSize: "12px", fontWeight: 600, fontFamily: "'IBM Plex Arabic', sans-serif", display: "flex", alignItems: "center", gap: "4px" }}
            >
              <Pencil size={13} /> تعديل
            </button>
            <button
              onClick={onToggle}
              style={{ background: "transparent", border: "1px solid #E5E5E0", borderRadius: "8px", padding: "7px 12px", cursor: "pointer", color: src.active ? "#D97706" : "#059669", fontSize: "12px", fontWeight: 600, fontFamily: "'IBM Plex Arabic', sans-serif", display: "flex", alignItems: "center", gap: "4px" }}
            >
              {src.active ? <><ToggleLeft size={13} /> تعطيل</> : <><ToggleRight size={13} /> تفعيل</>}
            </button>
            <button
              onClick={onDelete}
              style={{ background: "#FEF2F2", border: "none", borderRadius: "8px", padding: "7px 12px", cursor: "pointer", color: "#DC2626", fontSize: "12px", fontWeight: 600, fontFamily: "'IBM Plex Arabic', sans-serif", display: "flex", alignItems: "center", gap: "4px" }}
            >
              <Trash2 size={13} /> حذف
            </button>
          </div>
      ...
      <div style={{ padding: "32px 24px", maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ marginBottom: "28px" }}>
          ...
          <p style={{ color: "#6B6B6B", marginTop: "4px", fontSize: "14px" }}>
            المعلومات التي يجاوب منها سالم — أضف أو عدّل أو عطّل في أي وقت
          </p>
        </div>
        ...
        <form onSubmit={add} style={{ background: "white", borderRadius: "16px", padding: "28px", boxShadow: "0 4px 24px rgba(26,39,68,0.06)", marginBottom: "28px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="مثال: قائمة الخدمات، الأسئلة الشائعة، سياسة الأسعار..."
              style={inputStyle}
            />
          </div>
          <div>
